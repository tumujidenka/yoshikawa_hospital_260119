    ...
    <section class="p-top-mv">
        <div class="p-top-mv__inner">
            <div class="p-top-mv__content">
                ...
                <p class="p-top-mv__text">地域に根ざした医療で、<br class="u-sp-only">皆さまの健康をサポートします。</p>
                <div class="p-top-mv__buttons">
                    <a href="<?php echo esc_url(home_url('/contact')); ?>" class="c-btn c-btn--primary c-btn--lg">予約・お問い合わせ</a>
                    <a href="<?php echo esc_url(home_url('/about')); ?>" class="c-btn c-btn--outline c-btn--lg">詳細はこちら</a>
                </div>
            </div>
        </div>
    ...
    <section class="p-top-news">
        <div class="p-top-news__inner">
            ...
            <ul class="p-top-news__list">
                ...
                <li class="p-top-news__item">
                    <a href="<?php the_permalink(); ?>" class="p-top-news__link">
                        <time class="p-top-news__date" datetime="<?php echo esc_attr(get_the_date('Y-m-d')); ?>"><?php echo esc_html(get_the_date('Y.m.d')); ?></time>
                        <?php
            ...
            <div class="p-top-news__more">
                <a href="<?php echo esc_url(home_url('/news')); ?>" class="c-btn c-btn--secondary c-btn--arrow">すべて見る</a>
            </div>
        </div>
    </section>
        ...
        <div class="p-top-features__inner">
            ...
            <div class="p-top-features__list">
                ...
                <div class="p-top-features__item">
                    <div class="p-top-features__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M20 6h-4V4c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-8-2h4v2h-4V4zM4 20V8h16v12H4zm8-10c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/>
                        </svg>
                    </div>
            ...
            <div class="p-top-features__more">
                <a href="<?php echo esc_url(home_url('/features')); ?>" class="c-btn c-btn--secondary c-btn--arrow">もっと見る</a>
            </div>
        </div>
    </section>
        ...
        <div class="p-top-departments__inner">
            ...
            <ul class="p-top-departments__list">
                <li class="p-top-departments__item">
                    <a href="<?php echo esc_url(home_url('/departments/internal')); ?>" class="p-top-departments__link">内科</a>
                </li>
                <li class="p-top-departments__item">
                    <a href="<?php echo esc_url(home_url('/departments/surgery')); ?>" class="p-top-departments__link">外科</a>
                </li>
                <li class="p-top-departments__item">
                    <a href="<?php echo esc_url(home_url('/departments/proctology')); ?>" class="p-top-departments__link">肛門外科</a>
                </li>
                <li class="p-top-departments__item">
                    <a href="<?php echo esc_url(home_url('/departments/orthopedics')); ?>" class="p-top-departments__link">整形外科</a>
                </li>
                <li class="p-top-departments__item">
                    <a href="<?php echo esc_url(home_url('/departments/urology')); ?>" class="p-top-departments__link">泌尿器科</a>
                </li>
                <li class="p-top-departments__item">
                    <a href="<?php echo esc_url(home_url('/departments/dermatology')); ?>" class="p-top-departments__link">皮膚科</a>
                </li>
                <li class="p-top-departments__item">
                    <a href="<?php echo esc_url(home_url('/departments/rehabilitation')); ?>" class="p-top-departments__link">リハビリテーション科</a>
                </li>
            </ul>
            <div class="p-top-departments__more">
                <a href="<?php echo esc_url(home_url('/departments')); ?>" class="c-btn c-btn--secondary c-btn--arrow">診療案内を見る</a>
            </div>
        </div>
    </section>
    ...
    <section class="p-top-cta">
        <div class="p-top-cta__inner">
            ...
            <div class="p-top-cta__buttons">
                ...
                <a href="<?php echo esc_url(home_url('/contact')); ?>" class="c-btn c-btn--secondary c-btn--lg">お問い合わせフォーム</a>
            </div>
        </div>
    </section>
</main>
