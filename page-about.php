    ...
    <section class="p-about-overview">
        <div class="p-about-overview__inner">
            ...
            <div class="p-about-overview__message">
                <p>長期に渡り、患者様が住み慣れた地域で安心して暮らし続けられるよう、外来診療のかかりつけとして、入院が必要なケースも含め、きめ細やかな医療とケアを心かけてきました。
                </p>
                <p>急な体調変化や怪我にも対応し、患者様はもちろんご家族も安心できる、医療機関を目指しています。また、地域の医療機関との連携体制も整え、必要に応じて専門病院やより高次の医療機関をご紹介し、患者様にとって最善の医療につなげるよう尽力します。施設入所中や在宅での体調不良（発熱、食欲低下、など）、廃用症候群の進行などの生活が困難な状況に、可能な限り最善の医療につなげるよう尽力いたします。
                </p>
            </div>
        </div>
    </section>
