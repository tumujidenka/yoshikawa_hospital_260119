    ...
    <section class="p-about-overview">
        <div class="p-about-overview__inner">
            ...
            <div class="p-about-overview__message">
                ...
                <p>急な体調変化や怪我にも対応し、患者様はもちろんご家族も安心できる、医療機関を目指しています。また、地域の医療機関との連携体制も整え、必要に応じて専門病院やより高次の医療機関をご紹介します。施設入所中や在宅での体調不良（発熱、食欲低下、など）、廃用症候群の進行などの生活が困難な状況に、可能な限り最善の医療につなげるよう尽力いたします。
                </p>
            </div>
        </div>
    </section>
