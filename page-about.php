    ...
    <section class="p-about-overview">
        <div class="p-about-overview__inner">
            ...
            <div class="p-about-overview__info-table">
                <table class="p-about-table">
                    <tbody>
                        ...
                        <tr>
                            <th>診療科目</th>
                            <td>外科・内科・整形外科・<br class="u-sp-only">ペインクリニック・肛門外科・<br class="u-sp-only">泌尿器科・皮膚科・<br
                                    class="u-sp-only">リハビリテーション科・もの忘れ外来・精神科</td>
                        </tr>
                        <tr>
                            <th>所在地</th>
            ...
            <div class="p-about-overview__message">
                <p>長期に渡り、患者様が住み慣れた地域で安心して暮らし続けられるよう、地域のかかりつけとして、外来診療から入院が必要な場合まで、きめ細やかな医療とケアを心がけてきました。
                </p>
                <p>急な体調変化やけがにも対応し、患者様はもちろんご家族も安心していただける医療機関を目指しています。また、地域の医療機関との連携体制も整え、必要に応じて専門病院やより高次の医療機関をご紹介します。施設や住宅で療養されている方の体調不良（発熱、食欲低下など）や廃用症候群の進行などの生活が困難となる状況においても、患者様一人一人の状況に応じて、最善の医療につなげるように尽力します。
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="p-about-doctor__list">
                ...
                <div class="p-about-doctor__card p-about-doctor__card--sub">
                    ...
                    <div class="p-about-doctor__info">
                        ...
                        <p class="p-about-doctor__specialty">内科、外科、救急医療、ペインクリニック内科、もの忘れ外来、その他の疾患</p>
                        <div class="p-about-doctor__qualifications">
                            <span class="p-about-doctor__qualifications-label">資格</span>
                            <ul>
                                <li>医学博士</li>
